...
from GNN.loss.subtoken_prediction_loss import subtoken_cross_entropy
from GNN.utils import cfg_to_dict, flatten_dict, make_wandb_name, dirichlet_energy, mean_average_distance, mean_norm
...
def log_attn_weights(loggers, loaders, model, optimizer=None, scheduler=None):
    ...
    from GNN.utils import unbatch, unbatch_edge_index
